...
import PortalComponent from '../PortalComponent.vue';
...
//@ts-expect-error the value connot be null when computed
...
<template>
  <PortalComponent v-if="selectedExercise" :handleCloseModal="handleCloseModal">
